...
#Adicionando itens
    ...
    if ((gd == 0) and (utm == 1) and (inf_zona != '')):        
        ...
        if (inf_lat != '') and (inf_lon != '') and (inf_lat != inf_lon) and (inf_lat != inf_lat[-1] and inf_lon != inf_lon[-1]):           
            ...
            #Condição de controle para a largura da linha
            if inf_largura == '':
                inf_largura = 5
...
- O campo Título está relacionado ao arquivo 'config', portanto o usuário pode definir os títulos se for conveniente.''')
...
def menu_arq_github_f(self, criar_kml):
    #print('menu_arq_github_f')       
    try:
        #print('Abrir_página_github_ok.')
        os.system("start \"\" https://github.com/Alexsandro1997/kml_plote_28052021")
    except:
        #print('Abrir_página_github_não.')
        pass
    
#Função do botão do menu "Arquivo de ajuda"
def menu_arq_sobre_f(self, criar_kml):
    #print('menu_arq_sobre_f')       
    try:
        #print('Abrir_página_github_ok.')
        os.system("start \"\" Ajuda.docx")
    except:
        #print('Abrir_arquivo_ajuda_não.')
        pass
